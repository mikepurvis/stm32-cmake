...
FUNCTION(STM32_ADD_HEX_BIN_TARGETS TARGET)
    ADD_CUSTOM_TARGET(${TARGET}.hex DEPENDS ${TARGET}
        COMMAND ${CMAKE_OBJCOPY} -Oihex ${EXECUTABLE_OUTPUT_PATH}/${TARGET}
                                        ${EXECUTABLE_OUTPUT_PATH}/${TARGET}.hex)
    ADD_CUSTOM_TARGET(${TARGET}.bin DEPENDS ${TARGET} 
        COMMAND ${CMAKE_OBJCOPY} -Obinary ${EXECUTABLE_OUTPUT_PATH}/${TARGET}
